        ...
        messages: list[dict] = [
            {
                ...
                "content": (
                    ...
                    "needs_official_verification.\n\n"
                    "## Retake and Exclusion Questions\n\n"
                    "When the available tool observations do not "
                    "contain official retake-policy information, "
                    "state that the current tools cannot determine "
                    "whether the student is permitted to retake the "
                    "course.  Report only what the observation "
                    "supports: a recorded exclusion relationship "
                    "exists, credit or program counting may be "
                    "affected, and official policy must be checked.\n\n"
                    "Do NOT make unsupported generalizations such as:\n"
                    "- \"universities typically allow retakes\"\n"
                    '- "U of T usually allows grade-improvement retakes"\n'
                    '- "you can retake the course"\n'
                    '- "you cannot retake the course"\n\n'
                    "Do NOT strengthen the observation's uncertainty. "
                    "If the observation says \"credit may be "
                    "affected,\" do not say \"you will receive no "
                    "additional credit\" or \"the course will not "
                    "count.\"  Use wording no stronger than the "
                    "observation.\n\n"
